...
public:
	...
	Sequence(const Sequence& copy); // Copy constructor for Sequence

	~Sequence(); // Desctructor for Sequence;

	Sequence& operator=(const Sequence& value); // Assignment operator "=" for Sequence.
